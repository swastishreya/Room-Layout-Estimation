...
class Trainer:
    ...
    def calculate_loss(self, pred, target, metrics, bce_weight=0.5):
            ...
            for phase in ['train', 'val']:
                ...
                for images, masks in self.dataloaders[phase]:
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        loss = self.calculate_loss(outputs, masks, metrics)
...
if __name__ == "__main__":
    ...
    trainer = Trainer(unet, optimizer, exp_lr_scheduler)
    trainer.train()
